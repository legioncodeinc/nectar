...
export const DEFAULT_COHERE_EMBED_MODEL = "embed-v4.0" as const;
 ...
 */
export const DEFAULT_COHERE_REQUEST_TIMEOUT_MS = 15_000 as const;
 ...
 */
export function createCoherePortkeyProvider(
  config: CohereEmbeddingsConfig,
  deps: CoherePortkeyDeps = {},
): EmbedProvider {
