...
export const HIVE_GRAPH_COLUMNS: readonly ColumnDef[] = [
...
export const HIVE_GRAPH_VERSIONS_COLUMNS: readonly ColumnDef[] = [
  { name: "nectar", type: "TEXT", notNull: true, default: "" },
...
export const HIVE_GRAPH_TABLE: CatalogTable = {
  name: "hive_graph",
  scope: "tenant",
...
export const HIVE_GRAPH_VERSIONS_TABLE: CatalogTable = {
