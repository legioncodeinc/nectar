...
- Acceptance: hivedoctor's supervisor classifies the probe result without code change — the contract is the coarse `status` field (mirroring [`supervisor.ts:261-320`](../../../../honeycomb/hivedoctor/src/supervisor.ts)).
...
- hivedoctor probe + supervisor classification: [`honeycomb/hivedoctor/src/config.ts:36-38,53,75,155`](../../../../honeycomb/hivedoctor/src/config.ts); [`honeycomb/hivedoctor/src/supervisor.ts:261-320`](../../../../honeycomb/hivedoctor/src/supervisor.ts) (the `tick` that routes ok vs unhealthy).
