...
- [`prd-002-hivenectar-daemon`](../../completed/prd-002-hivenectar-daemon/prd-002-hivenectar-daemon-index.md) — produces the runnable daemon + mounts the `/health` route this PRD's group sits beside.
- [`prd-005-source-graph-catalog-tables`](../../completed/prd-005-source-graph-catalog-tables/prd-005-source-graph-catalog-tables-index.md) — owns the tables these endpoints read/write.
