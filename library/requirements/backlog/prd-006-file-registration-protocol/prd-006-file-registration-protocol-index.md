...
Per [`hivenectar-stinger` guide 00 § Principle 3](../../../../../.agents/skills/hivenectar-stinger/guides/00-principles.md), two values remain unspecified on purpose. This PRD surfaces them as gaps, not numbers:
...
- [`honeycomb/src/daemon/runtime/services/file-watcher.ts:333-375`](../../../../honeycomb/src/daemon/runtime/services/file-watcher.ts) — the `fs.watch` intake + debounce pattern to mirror.
- [`honeycomb/src/daemon/runtime/services/file-watcher.ts:177-183, 234-316`](../../../../honeycomb/src/daemon/runtime/services/file-watcher.ts) — `debounceMs = 500` default, `runSyncCycle` settled handler, `scheduleSyncCycle` debounce scheduler.
- [`honeycomb/src/daemon/runtime/codebase/api.ts:234-261`](../../../../honeycomb/src/daemon/runtime/codebase/api.ts) — `runGraphBuild` as the parallel "respond to file change" discover→persist template.
