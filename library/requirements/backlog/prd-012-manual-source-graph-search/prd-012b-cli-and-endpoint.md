...
- Confirm the CLI is a **thin client** that reaches the daemon over loopback (mirroring the operational-verb posture in [`prd-002c`](../../completed/prd-002-hivenectar-daemon/prd-002c-hivenectar-cli-surface.md)), not a process that imports the search engine directly.
...
**Entry binary / namespace:** the operational-verb namespace (reaches the daemon over loopback `:3854`), mirroring the `brood`/`prune`/`review-matches`/`rebuild-projection` posture in [`prd-002c`](../../completed/prd-002-hivenectar-daemon/prd-002c-hivenectar-cli-surface.md). It is a thin client: it imports the unified dispatcher + the CLI-side composition root, never the daemon core or any DeepLake path.
...
**Acceptance criteria:**
- AC-012b.3.1 Given the daemon is running, then the CLI reaches it over loopback `:3854` and never imports the daemon core or any DeepLake path, mirroring the operational-verb posture in [`prd-002c`](../../completed/prd-002-hivenectar-daemon/prd-002c-hivenectar-cli-surface.md).
...
- **Thin-client posture.** The CLI reaches the daemon over loopback like the other operational verbs ([`prd-002c`](../../completed/prd-002-hivenectar-daemon/prd-002c-hivenectar-cli-surface.md)); it does not embed the search engine. A `--json` flag makes the CLI's output identical to the endpoint's for scripting.
...
- **[DEFAULT — confirm before implementation]** CLI command `hivenectar search <query>`. The proposed command is named in [`MASTER-PRD-INDEX.md`](../../MASTER-PRD-INDEX.md) CLI table ("`hivenectar search` (proposed) — manual source-graph search"); the `<query>` positional + `--limit`/`--json` flags follow the operational-verb conventions in [`prd-002c`](../../completed/prd-002-hivenectar-daemon/prd-002c-hivenectar-cli-surface.md). From the corpus's proposed command, confirm.
...
- [`../../completed/prd-002-hivenectar-daemon/prd-002c-hivenectar-cli-surface.md`](../../completed/prd-002-hivenectar-daemon/prd-002c-hivenectar-cli-surface.md) — the operational-verb namespace + thin-loopback-client posture `search` joins.
