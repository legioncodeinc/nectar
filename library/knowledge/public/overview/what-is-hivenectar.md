...
A 60-second introduction for anyone new to Hivenectar — what it is, the problem it solves, how it works in plain terms, and what it is not.
...
Hivenectar is a memory layer that helps your AI coding assistant understand your codebase by meaning, not just by file names.

If you ask your agent "where do we handle logins?" it should hand you the right files — even if none of them are named `login.ts`. That is the job Hivenectar does.
...
- **It is not a search tool you use yourself.** You will not open a Hivenectar search box. It works behind the scenes, through your AI coding assistant.
...
- **It is not a way to read every line of your code.** Hivenectar reads enough of each file to describe it accurately. It does not memorize your source code line by line.

---

## What you actually notice

After Hivenectar has learned your codebase, the change is quiet but real:
...
- [`how-hivenectar-helps-your-agent.md`](how-hivenectar-helps-your-agent.md) — a before-and-after walkthrough of one real question.
- [`hivenectar-glossary.md`](hivenectar-glossary.md) — plain-language definitions of the words you will see.
